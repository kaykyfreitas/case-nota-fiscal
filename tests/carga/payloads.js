...
export function pjSimplesPayload() {
  return JSON.stringify({
    id_pedido: 1,
    data: "2022-05-01",
    valor_total_itens: 5840.0,
    valor_frete: 72.0,
    itens: [{ id_item: 1, descricao: "Monitor LCD SAMSUNG", valor_unitario: 730, quantidade: 8 }],
    destinatario: {
      nome: "John Doe",
